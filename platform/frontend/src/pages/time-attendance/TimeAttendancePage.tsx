...
interface AttendanceResponse {
  ...
  needsData?: boolean;
  message?: string;
  coverage?: { employees: number; dailyAssignments: number; routeReconciliationAvailable: boolean };
