...
const WeeklyRoutePerformancePage: React.FC = () => {
  ...
  const {data,isLoading,error,refetch}=useQuery<Payload>({queryKey:['weekly-route-performance'],queryFn:()=>api.get<Payload>('/route-performance')});
