...
const VansPage: React.FC = () => {
  ...
  return <div className="space-y-6">
    ...
    <OperationalSourceBanner source="Amazon Cortex Fleet Dashboard" detail="Fleet size, ownership, operational status, and grounded status come from the live Cortex Fleet Dashboard vehicle feed. PAVE supplies separate assessment and wear-and-tear evidence." />
